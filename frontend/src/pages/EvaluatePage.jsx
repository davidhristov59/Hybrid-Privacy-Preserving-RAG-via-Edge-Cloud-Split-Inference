...
export const EvaluatePage = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 pb-12">
            <div>
                <h1 className="text-3xl font-bold tracking-tight mb-2">Evaluation Metrics</h1>
                <p className="text-muted-foreground">Test the generation quality and privacy preservation of the system.</p>
            </div>
